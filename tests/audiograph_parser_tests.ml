...
let parsing test_ctxt =
  ...
  let node1 = G.V.create {id="id-1"; nb_inlets=1; nb_outlets=2; className="plop"; text=Some "salut" ; more=[] } in
  let node2 = G.V.create {id="id-3"; nb_inlets=1; nb_outlets=0; className="plop2"; text=None ; more=[] } in
